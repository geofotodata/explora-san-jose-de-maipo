...
<meta name="theme-color" content="#173f35"><link rel="icon" href="{prefix}assets/icon.svg"><link rel="manifest" href="{prefix}manifest.webmanifest">
<link rel="stylesheet" href="{prefix}styles.css"><link rel="stylesheet" href="{prefix}visitor-guide.css"><link rel="stylesheet" href="{prefix}assets/vendor/maplibre-gl.css"><link rel="stylesheet" href="{prefix}territory-map.css"><link rel="stylesheet" href="{prefix}guide.css"></head>
<body><a class="skip-link" href="#contenido">Saltar al contenido</a><header class="guide-header"><div class="container masthead"><a class="guide-brand" href="{prefix}index.html">EXPLORA <span>San José de Maipo</span></a><span class="guide-label">GUÍA DEL TERRITORIO</span><button id="guide-menu" aria-controls="guide-nav" aria-expanded="false" type="button">Menú</button></div><nav id="guide-nav" class="container guide-nav" aria-label="Navegación principal">{links}</nav></header>
